...
<div class="bg-light">
    @auth
    <h1 class="tx-head">category name</h1>
        ...
        <div class="col-sm-6">
            <div class="card w-0 text-center mx-3 mb-3" style="border-radius: 8px; border-bottom: 6px solid red; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                ...
                <div class="card-body">
                    ...
                    <p class="btn-holder"><a href="{{ route('add.to.cart', $product->productCode) }}" class="btn text-center btn-outline-danger" role="button">Add to cart</a> </p>
